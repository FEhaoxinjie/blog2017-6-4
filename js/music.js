...
(function() {
	var musicControl = document.getElementById("music-stop"),
		...
		musicTitleElement = document.getElementById("music-name"),
		addMusicElement = document.getElementById("add-music"),
		albumPicElment = document.getElementById("image"),
		...
		musiclist_control = document.getElementById("music-list-control"),
		musiclist_controls = document.getElementById("music-list"),
		liElementsCache = [];
	...
	(function init() {
		var music = new Music("风筝误", "css/music/fly.ogg");
	...
	musiclist_control.addEventListener("click",function () {
		if (musiclist_control.classList=="fa fa-chevron-circle-down")
		{
			...
			musiclist_control.classList.remove("fa-chevron-circle-up")
			musiclist_control.classList.add("fa-chevron-circle-down")
			musiclist_controls.classList.remove("animationUp")
			musiclist_controls.classList.add("animationDown")
			musiclist_controls.classList.remove("special")
		}
